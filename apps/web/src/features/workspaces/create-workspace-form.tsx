...
export function CreateWorkspaceForm() {
  ...
  return (
    <form action={formAction} className="rounded-card border border-outline-variant bg-surface p-6 shadow-candy-primary">
      ...
      <div className="mt-5">
        <p className="text-sm font-bold text-on-surface-variant">Color</p>
      ...
      <button
        type="submit"
        disabled={pending}
        className="bouncy-hover mt-6 w-full rounded-pill bg-primary px-5 py-3 font-bold text-on-primary shadow-candy-primary disabled:opacity-60"
      >
