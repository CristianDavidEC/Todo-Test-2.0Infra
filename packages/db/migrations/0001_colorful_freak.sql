...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "workspace_memberships_ws_user_unique" ON "workspace_memberships" USING btree ("workspace_id","user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "workspace_memberships_ws_idx" ON "workspace_memberships" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspaces_created_by_idx" ON "workspaces" USING btree ("created_by");